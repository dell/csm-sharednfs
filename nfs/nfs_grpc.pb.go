...
const (
	Nfs_ExportNfsVolume_FullMethodName            = "/nfs.v1.Nfs/ExportNfsVolume"
	Nfs_UnexportNfsVolume_FullMethodName          = "/nfs.v1.Nfs/UnexportNfsVolume"
	Nfs_Ping_FullMethodName                       = "/nfs.v1.Nfs/Ping"
	Nfs_GetExports_FullMethodName                 = "/nfs.v1.Nfs/GetExports"
	Nfs_ExportMultipleNfsVolumes_FullMethodName   = "/nfs.v1.Nfs/ExportMultipleNfsVolumes"
	Nfs_UnexportMultipleNfsVolumes_FullMethodName = "/nfs.v1.Nfs/UnexportMultipleNfsVolumes"
)
...
func (c *nfsClient) ExportNfsVolume(ctx context.Context, in *ExportNfsVolumeRequest, opts ...grpc.CallOption) (*ExportNfsVolumeResponse, error) {
	...
	err := c.cc.Invoke(ctx, Nfs_ExportNfsVolume_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nfsClient) UnexportNfsVolume(ctx context.Context, in *UnexportNfsVolumeRequest, opts ...grpc.CallOption) (*UnexportNfsVolumeResponse, error) {
	...
	err := c.cc.Invoke(ctx, Nfs_UnexportNfsVolume_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nfsClient) Ping(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PingResponse, error) {
	...
	err := c.cc.Invoke(ctx, Nfs_Ping_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nfsClient) GetExports(ctx context.Context, in *GetExportsRequest, opts ...grpc.CallOption) (*GetExportsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Nfs_GetExports_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nfsClient) ExportMultipleNfsVolumes(ctx context.Context, in *ExportMultipleNfsVolumesRequest, opts ...grpc.CallOption) (*ExportMultipleNfsVolumesResponse, error) {
	...
	err := c.cc.Invoke(ctx, Nfs_ExportMultipleNfsVolumes_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nfsClient) UnexportMultipleNfsVolumes(ctx context.Context, in *UnexportMultipleNfsVolumesRequest, opts ...grpc.CallOption) (*UnexportMultipleNfsVolumesResponse, error) {
	...
	err := c.cc.Invoke(ctx, Nfs_UnexportMultipleNfsVolumes_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations should embed UnimplementedNfsServer
...
// UnimplementedNfsServer should be embedded to have forward compatible implementations.
